...
<table >
  <tr>
    <td align="center">
      <img src="ScrShots/Mobile-DarkMode.jpeg" width="250" alt="Mobile Dark Mode"><br>
      <em>Mobile Dark Mode</em>
    </td>
    <td width="30"></td> <!-- space between images -->
    <td align="center">
...
I am not using it for my regular Blogger blogs, as of now at least, but may consider using it for one of my Blogger blogs which I regularly monitor and maintain. 
...
To upgrade to a newer version of the theme (for example, to incorporate security patches or new features), a developer will need to review the customization code against the updated default theme and make any required adjustments.  
...
1. Backup your current theme: Theme -> Customize (dropdown) -> Backup.
2. Edit the Theme HTML: Theme -> Edit HTML.
